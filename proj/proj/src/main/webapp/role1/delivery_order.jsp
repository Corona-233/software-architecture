...
<div id="page" class="container">
    ...
    <div id="main">
        <div class="top">
            ...
            <div class="find">
                <form action="DeliveryOrderServletSearch" method="post">
...
<div id="add-dialog" title="添加出场清单" style="display:none;">
    <form id="add-form" method="post">
        ...
        <div class="form-row">
            <label for="construction_site">施工部位:</label>
        ...
        <button type="submit" class="btn btn-primary" formaction="DeliveryOrderServletAdd">确定</button>
    </form>
</div>
