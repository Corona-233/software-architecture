...
<body>
<%
    List<DeliveryOrder> deliveryOrders = (List<DeliveryOrder>) request.getAttribute("acceptance");
...
<div id="page" class="container">
    <div id="header">
        <div id="logo">
            ...
            <p style="color: #9fcdff">验收人员</p>
        </div>
        <div id="menu">
            <ul>
                <li><a href="index.jsp">主页</a></li>
                <li  class="current_page_item"><a href="AcceptanceServletSearch">工地验收人员界面</a></li>
            </ul>
        </div>
    </div>
    <div id="main">
                    ...
                    <form method="post" action="DeliveryOrderServletUpdate">
                        ...
                        <td>
                            <%
                                ...
                                if ("0".equals(Is_accept) || "null".equals(Is_accept) || Is_accept == null || Is_accept.isEmpty()) {
                                    Is_acceptText = "未接收";
                                } else {
                                    Is_acceptText = "已接收";
                                }
                        ...
                        <td>
                            &nbsp;<a class="btn-delete" onclick="return confirm('确定接收吗（不可更改）?');" href="Accept?id=<%=deliveryOrder.getId()%>">接收</a>
                        </td>
                    </form>
                </tr>
                <%
