package servlet.WaysServlet.role1;
...
@WebServlet("/role1/WaysServletSearch")
public class WaysServletSearch extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("way.jsp");
