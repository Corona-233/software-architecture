package servlet.DeliveryOrderServlet.role2;
...
@WebServlet("/role2/DeliveryOrderServletAdd")
public class DeliveryOrderServletAdd extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            dao.addDeliveryOrder(task_num, project_name, concrete_mark, construction_site, production_date, purchase_unit, plan_cubic_meter, contract_number, anti_seepage_level, other_technical, concrete_strengh, design_ratio, required_slab_fall, mixing_plant, transport_distance,actual_cubic_meter, remarks, way);
