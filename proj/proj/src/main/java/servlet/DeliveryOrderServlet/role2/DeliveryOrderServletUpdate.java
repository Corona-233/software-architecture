...
@WebServlet("/role2/DeliveryOrderServletUpdate")
public class DeliveryOrderServletUpdate extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            dao.updateDeliveryOrder(id,task_num,project_name,construction_site,way,plan_cubic_meter,actual_cubic_meter,production_date);
